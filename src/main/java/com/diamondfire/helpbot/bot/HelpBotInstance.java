...
public class HelpBotInstance {
    ...
    public static void initialize() throws LoginException {
        ...
        JDABuilder builder = JDABuilder.createDefault(config.getToken())
                ...
                .addEventListeners(new MessageEvent(), new ReadyEvent(), new GuildJoinEvent(), new ButtonEvent(), new MessageEditEvent(), new SlashInteractionEvent(), new GuildMemberUpdateEvent());
