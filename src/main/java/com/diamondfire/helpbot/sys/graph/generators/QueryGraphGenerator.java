...
public class QueryGraphGenerator implements GraphGenerator {
    ...
    @Override
    public File createGraph(TimeMode timeMode, int duration) {
        ...
        new DatabaseQuery()
                .query(new BasicQuery(query, statement -> {
                    ...
                    statement.setInt(2, timeMode.getUnitConversion().apply(duration));
                }))
                .compile()
                .run((result) -> {
